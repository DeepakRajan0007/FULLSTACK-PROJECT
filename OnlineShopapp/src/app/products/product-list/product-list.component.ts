...
export class ProductListComponent implements OnInit, AfterViewInit {
    ...
    manufacturers = [{ 'id': 'JSFashionIndia', 'checked': false },
    { 'id': 'Alamy', 'checked': false },{'id': 'Krishna Industries','checked': false},{'id': 'Toonyport','checked':false},
    {'id': 'Zoobom store','checked':false},{'id':'Menjestic','checked':false}
    ];
    materials = [{ 'id': 'Silk', 'checked': false },
    { 'id': 'Polyester', 'checked': false },{'id': 'Cotton', 'checked': false},{'id': 'Fabric', 'checked': false}];
    ...
    filter(name: any) {      
        ...
        this.checkedOS = this.materials.filter(product => product.checked).map(product => product.id);
    ...
    tabselect(producttype: string) {
        this.manufacturers = [{ 'id': 'JSFashionIndia', 'checked': false },
        { 'id': 'Alamy', 'checked': false },{'id': 'Krishna Shop','checked': false},{'id': 'Toonyport','checked':false},
        {'id': 'Zoobom store','checked':false},{'id':'Menjestic','checked':false}];
        this.materials = [{ 'id': 'Silk', 'checked': false },
        { 'id': 'Polyester', 'checked': false },{'id': 'Cotton', 'checked': false},{'id': 'Fabric', 'checked': false}];
